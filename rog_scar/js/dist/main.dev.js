...
$(function () {
  ...
  var performance＿float = 0;
  var qhd_float = 0; // let float5 = 0;
  ...
  $(window).scroll(function (e) {
    ...
    if (window.innerWidth < 732) {
      if ($(window).scrollTop() > $(".performance-notebook").offset().top - $(".performance-notebook").offset().top * 0.1) {
        ...
        $(".performance-notebook").css({
          "transform": "translateY(".concat(performance＿float, "px)")
        });
        $(".cpu").addClass("active");
        $(".gpu").addClass("active");
      } else {
    ...
    if (window.innerWidth < 732) {
      if ($(window).scrollTop() > $(".qhd-notebook").offset().top - $(".qhd-notebook").offset().top * 0.1) {
        ...
        $(".inner-sky img").css({
          "left": "".concat(qhd_float, "px"),
          "top": "".concat(qhd_float / 2, "px")
        });
      } else {
        float4 = 0;
        $(".inner-sky img").css({
          "left": "".concat(qhd_float, "px"),
          "top": "".concat(qhd_float, "px")
        });
      }
    } else {
