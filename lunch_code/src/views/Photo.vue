        ...
        <div class='inner-page'>
          ...
          <div class='contents block'>
            <div class='left'>
              ...
              <div class='en_title'>Show</div>
              <ul>
                <li v-for="(list, index) in KindData" :key="index">
                  <router-link :to="{name:'photo',params:{id:list.serial,title:list.title,s_title:list.s_title}}">{{list.title}}</router-link>
                </li>
              </ul>
            </div>
