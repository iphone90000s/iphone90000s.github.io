            ...
            <form ref="form" enctype="multipart/form-data" autocomplete="off" method="post" action="" name="submitform">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class='box' v-if="haspic">
                            <label class='h6'>目前已上傳圖片</label>
                            <img style='max-width:100px;' :src="baseurl+'/connect/upload/photo/'+this.image">
                        </div>
                        <div class='box'>
...
export default {
  ...
  methods: {
    ...
    checkForm: function() {
      ...
      this.$axios
        .post("/connect/save/save-photoin.php?id=" + this.ids, formData, {
          headers: {
  ...
  created() {
    ...
    if (this.$route.params.id != "add") {
      this.$axios
        .get("/connect/get/photo_in.php?id=" + this.$route.params.id, {})
        .then(response => {
